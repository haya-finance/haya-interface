      ...
      <Stack spacing={2} sx={{ width: '100%', alignItems: 'center', justifyContent: 'center' }}>
        <Stack direction="row" spacing={2} sx={{ width: '100%', alignItems: 'center', justifyContent: 'center' }}>
          <Stack spacing={2} sx={{ width: '30%', alignItems: 'center', justifyContent: 'start' }}>
            <Typography variant="h6" sx={{ color: '#64605f', width: '100%' }}><FormattedMessage id="sell" /></Typography>
            {/* <Grid sx={{ width: 200 }}> */}
            <TextField
        ...
        <Stack direction="row" spacing={2} sx={{ width: '100%', alignItems: 'center', justifyContent: 'center' }}>
          <Stack spacing={2} sx={{ width: '30%', alignItems: 'center', justifyContent: 'start' }}>
            <Typography variant="h6" sx={{ color: '#64605f', width: '100%' }}><FormattedMessage id="recevie" /></Typography>
            {/* <Grid sx={{ width: 200 }}> */}
            <TextField
              id="outlined-textarea"
        ...
        <Stack sx={{ justifyContent: 'left', width: '61%' }}>
          <Typography variant="body1" sx={{ color: '#64605f' }}><FormattedMessage id="sell-foot" /></Typography>
        </Stack>
