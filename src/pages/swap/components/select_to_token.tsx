...
import TokenToList from './select_toTokenList';
...
export default function SelectTOToken({ open, handleClose, handleListClose, data, windowWidth }: Props) {
  return (
    <>
      {
        windowWidth >= 600 ? (
          <BootstrapDialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open} sx={{ width: '100%' }}>
            ...
            <DialogContent>
              ...
              <TokenToList windowWidth={windowWidth} onClose={handleListClose} data={data} />
            </DialogContent>
          </BootstrapDialog>
        ) : (
