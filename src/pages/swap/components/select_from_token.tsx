...
import TokenFromList from './fromTokenList';
...
export default function SelectFromToken({ open, handleClose, handleListClose, data, windowWidth }: Props) {
  return (
    <>
      {
        windowWidth >= 600 ? (
          <BootstrapDialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open} sx={{ width: '100%' }}>
            ...
            <DialogContent>
              ...
              <TokenFromList windowWidth={windowWidth} onClose={handleListClose} data={data} />
            </DialogContent>
          </BootstrapDialog>
        ) : (
